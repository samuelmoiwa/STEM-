...
const speakerCardsItems = [
  {
    ...
    speaker_bio: `Software Engineer at africa Girls Empathy,  with more than 3 years experience
  ...
  },
  {
    ...
    speaker_bio: `Founder and CEO Africa Girls Empathy | STEM Ambassador | Women & Girls, Empowerment
                  | Climate activist | Social Entrepreneur | Innovator`,
  },
  {
  ...
  },
  {
    ...
    speaker_education: `Colorado Technical University Master of Science in Management,
                        Organizational Leadership and Change 2021 - 2022`,
    speaker_bio: `Program Manager at Federal Aviation Administration. Washington,
                  District of Columbia, United States `,
  },
  {
    speaker_image: 'images/img/speaker_abu.png',
    speaker_name: 'Abu Kamara',
    speaker_education: `Rutgers University International Economics 2001 - 2005. International
                        Trade, Business Management, Economic Analysis.`,
    speaker_bio: `CEO & Co-founder at Grovara, the exports and imports wholesale
                  marketplace for consumer brands.`,
  },
];
